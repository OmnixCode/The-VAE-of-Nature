...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 10 14:06:18 2023
...
class VAE_Decoder(nn.Sequential):
    ...
    def __init__(self,img_size, lat_size, dropout_early=True, der=0.2, dropout_late=True, dlr=0.1):
            #self.reshape_latent = nn.Linear(lat_size, (img_size * img_size)/16) 
            super().__init__(
                nn.Linear(lat_size, int((img_size * img_size)/16)),
